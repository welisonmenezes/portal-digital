                    ...
                    <div className="main-panel">
                        <div className="content-wrapper">
                            <Route render={({ location }) => (
                                <TransitionGroup>
                                    <CSSTransition key={location.pathname} classNames="fade" timeout={300} transitionAppear={true} transitionEnter={false} transitionLeave={false}>
                                        <Switch location={location}>
                                            ...
                                            <PrivateRouter path='/admin/usuarios/deletar/:id' exact={true} component={UserDelete} permissions={['admin']} />
                                            ...
                                            <PrivateRouter path='/admin/categorias/deletar/:id' exact={true} component={CategoryDelete} permissions={['admin']} />
